...
lib.ssMetadata = [
		{name:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_300x600_atlas_1", frames: [[1446,387,50,50],[0,0,300,600],[1743,321,291,294],[1193,0,300,343],[1495,0,246,385],[1193,345,251,300],[1743,0,275,319],[302,0,300,600],[604,0,300,541],[906,0,285,541]]}
];
...
(lib.arrows_w = function() {
	this.initialize(ss["PR_IdeaPad_Slim_5i_CM_FIFA_GDN_300x600_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.PRIdeaPadSlim5iCMFIFAGDN300x600 = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(15,24);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(250).to({_off:false},0).to({_off:true},50).wait(30));

	// F5
	this.instance_3 = new lib.F5();
	this.instance_3.setTransform(17,134);
	...
	this.instance_4.setTransform(24,135);
	...
	this.instance_5.setTransform(27,134);
	this.instance_5._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_5).wait(100).to({_off:false},0).to({_off:true},50).wait(180));

	// F2
	this.instance_6 = new lib.F2();
	this.instance_6.setTransform(0,134);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(50).to({_off:false},0).to({_off:true},50).wait(230));

	// F1
	this.instance_7 = new lib.F1();
	this.instance_7.setTransform(6,134);

	this.timeline.addTween(cjs.Tween.get(this.instance_7).to({_off:true},50).wait(280));
...
// library properties:
lib.properties = {
	id: 'B9715DAC75B2B34C8DEDC8978D1906C9',
	width: 300,
	height: 600,
	fps: 24,
	color: "#FFFFFF",
	opacity: 1.00,
	manifest: [
		{src:"images/PR_IdeaPad_Slim_5i_CM_FIFA_GDN_300x600_atlas_1.png", id:"PR_IdeaPad_Slim_5i_CM_FIFA_GDN_300x600_atlas_1"}
	],
	preloads: []
};
...
an.compositions['B9715DAC75B2B34C8DEDC8978D1906C9'] = {
